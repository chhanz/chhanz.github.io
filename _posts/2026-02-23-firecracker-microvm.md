...
![Firecracker microVM 부팅](/assets/images/post/2026-02-23-firecracker-microvm/2.png)

> **tmux를 활용한 백그라운드 실행**   
> 별도 터미널 없이 tmux session으로 관리할 수 있습니다.
> ```bash
> # tmux new-session -d -s u24 \
...
microVM 내부에서 외부 네트워크 연결도 확인합니다.
...
![microVM 네트워크 동작 확인](/assets/images/post/2026-02-23-firecracker-microvm/3.png)
